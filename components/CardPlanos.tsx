...
function CardPlanos() {
    return (
        <Card className="max-w-[500px] w-[500] h-[460px] shadow-xl shadow-slate-700 md:max-w-[370px] md:h-[470px] bg-green-700 mt-4 text-white  transform transition-transform duration-300 ease-in-out md:hover:scale-105">
