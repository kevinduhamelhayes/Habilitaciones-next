...
const Body = () => {
    return (
        <section className="w-full flex flex-col items-center bg-gray-800 text-white py-8">
            <h3 className="text-3xl mt-14 font-bold">
                Preguntas Frecuentes
            </h3>
            <Accordion variant="shadow" className="border-gray-600 bg-gray-700 max-w-[1100px] mt-12 text-gray-800 rounded-lg">
                {FAQs.map((faq) => (
